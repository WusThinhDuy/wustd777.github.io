...
<link rel="stylesheet" type="text/css" href="dist/sweetalert.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
     <script src="/assets/css/diggory.css"></script>
     <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>SPAM SMS- DIGGORY</title>
...
<body>
	...
	Swal.fire("Thông Báo", "website by:vanphuc","warning")
...
<div class="row h-100">
    <div class="col-lg-5 col-12">
        <div id="auth-left">
            ...
            <p class="auth-subtitle mb-5">Server free 5 api </p>
              
            <form   action = "serverfree" method="post"
 ...
 class="btn btn-primary btn-block btn-lg shadow-lg mt-5" onclick="showMessage()">Bắt Đầu
            ...
            <div class="text-center mt-5 text-lg fs-4">
                <p class="text-gray-600"><a href="sv1" class="font-bold"> 
